...
class Seq2SeqModel(object):
    ...
    def __init__(self, encoder_masks, encoder_inputs_tensor, 
        ...
        # single_cell = tf.contrib.rnn.core_rnn_cell.BasicLSTMCell(attn_num_hidden, forget_bias=0.0, state_is_tuple=False)  # original code
        ...
        if attn_num_layers > 1:
            # cell = tf.contrib.rnn.core_rnn_cell.MultiRNNCell([single_cell] * attn_num_layers, state_is_tuple=False)   # banglh: original code
        ...
        def seq2seq_f(lstm_inputs, decoder_inputs, seq_length, do_decode):
            ...
            # lstm_fw_cell = tf.contrib.rnn.core_rnn_cell.BasicLSTMCell(num_hidden, forget_bias=0.0, state_is_tuple=False)  # original code
            lstm_fw_cell = tf.contrib.rnn.BasicLSTMCell(num_hidden, forget_bias=0.0, state_is_tuple=False)
            # Backward direction cell
            # lstm_bw_cell = tf.contrib.rnn.core_rnn_cell.BasicLSTMCell(num_hidden, forget_bias=0.0, state_is_tuple=False)  # original code
